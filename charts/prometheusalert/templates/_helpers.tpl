...
{{ include "prometheusalert.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "prometheusalert.selectorLabels" -}}
...
{{- default (include "prometheusalert.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "prometheusalert.namespace" -}}
